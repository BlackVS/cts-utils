...
# Title: Simple receiver or test.raw file
# Author: vvs
...
class rx_file(gr.top_block, Qt.QWidget):

    def __init__(self, server_ip="127.0.0.1"):
        gr.top_block.__init__(self, "Simple receiver or test.raw file")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simple receiver or test.raw file")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_file")
        ...
        # Blocks
        ##################################################
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, server_address, 100, True, -1)
        ...
        # Connections
        ##################################################
        self.connect((self.zeromq_sub_source_0, 0), (self.blocks_tag_debug_0, 0))
...
def main(top_block_cls=rx_file, options=None):
    if options is None:
