...
class rx_simple(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, server_ip="127.0.0.1"):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_simple")
...
def main(top_block_cls=rx_simple, options=None):
    if options is None:
